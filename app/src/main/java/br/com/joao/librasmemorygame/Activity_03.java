...
public class Activity_03 extends AppCompatActivity  implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        jogo[0][0] = (ImageView) findViewById(R.id.imageView301);
        jogo[0][1] = (ImageView) findViewById(R.id.imageView302);
        jogo[0][2] = (ImageView) findViewById(R.id.imageView303);
        jogo[1][0] = (ImageView) findViewById(R.id.imageView304);
        jogo[1][1] = (ImageView) findViewById(R.id.imageView305);
        jogo[1][2] = (ImageView) findViewById(R.id.imageView306);
        jogo[2][0] = (ImageView) findViewById(R.id.imageView307);
        jogo[2][1] = (ImageView) findViewById(R.id.imageView308);
        jogo[2][2] = (ImageView) findViewById(R.id.imageView309);
        jogo[3][0] = (ImageView) findViewById(R.id.imageView310);
        jogo[3][1] = (ImageView) findViewById(R.id.imageView311);
        jogo[3][2] = (ImageView) findViewById(R.id.imageView312);
        jogo[4][0] = (ImageView) findViewById(R.id.imageView313);
        jogo[4][1] = (ImageView) findViewById(R.id.imageView314);
        jogo[4][2] = (ImageView) findViewById(R.id.imageView315);
        jogo[5][0] = (ImageView) findViewById(R.id.imageView316);
        jogo[5][1] = (ImageView) findViewById(R.id.imageView317);
        jogo[5][2] = (ImageView) findViewById(R.id.imageView318);

        botaoNovasCartas = (Button) findViewById(R.id.button31);
